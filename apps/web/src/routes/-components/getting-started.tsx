      ...
      <div className="shell py-20 sm:py-24">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-xl text-lg leading-7 text-muted-foreground">
            No scaffold CLI to run: the prompt reads the repo, asks your app's name, walks you through the one Cloudflare credential made by hand, and opens your first
            pull request with a running preview.
          </p>
        </div>
        <div className="relative mx-auto mt-10 max-w-[840px] rounded-xl border border-primary/15 bg-primary/5 dark:border-primary/20">
          ...
          <pre className="overflow-x-auto whitespace-pre-wrap p-6 pr-14 font-mono text-sm leading-relaxed text-foreground">{getStartedPrompt}</pre>
        </div>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Button asChild variant="ghost">
            <a href="https://github.com/Fawwaz-2009/proof" target="_blank" rel="noreferrer">
              <GithubMark className="mr-2 h-4 w-4" aria-hidden="true" />
              GitHub
            </a>
          </Button>
        </div>
